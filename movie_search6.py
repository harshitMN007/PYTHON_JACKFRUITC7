...
API_KEY = "c27c475407mshf74e48a0f77451bp1007dajsnd881d5c2770d"   # PUT YOUR RAPIDAPI KEY HERE
...
tk.Label(top_frame, text="Enter movie name:").pack(side="left")
entry = tk.Entry(top_frame, width=40)
entry.pack(side="left", padx=5)

tk.Button(top_frame, text="Search", command=on_search).pack(side="left")
